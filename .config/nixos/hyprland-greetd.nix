...
in
{
  ...
  programs.dms-shell.quickshell.package = inputs.quickshell.packages.${pkgs.system}.quickshell;
  ...
  services.greetd = {
    ...
    settings.default_session = {
      command = "${pkgs.tuigreet}/bin/tuigreet --time --user-menu --remember-session --remember --cmd Hyprland";
      user = "daniel";
    };
  };
